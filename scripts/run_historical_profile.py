...
def main() -> None:
    ...
    workflow = HistoricalProfileWorkflow(
    ...
    args.output.write_text(json.dumps(asdict(result), ensure_ascii=False, indent=2), encoding="utf-8")
    print(f"historical profile run written: {args.output}")
